    ...
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="text-center space-y-2">
          <Compass
            className="w-10 h-10 text-emerald-500 dark:text-emerald-400 mx-auto"
            strokeWidth={1.5}
          />
        ...
        {/* Error */}
        {error && (
          <div className="bg-red-50 dark:bg-red-950/50 border border-red-100 dark:border-red-900 text-red-700 dark:text-red-400 text-sm rounded-xl px-4 py-3">
            {error}
          </div>
        )}
